...
export class City {
	...
	public static init() {
		...
		//Jordan
		Cities[0] = new City(-16320.0, 3520.0, UID.CITY)
		Cities[24] = new City(-17472.0, 4032.0, UID.CITY)
		//Mozambique
		Cities[1] = new City(-17472.0, -13888.0, UID.CITY)
		Cities[2] = new City(-16448.0, -12736.0, UID.CITY)
		Cities[3] = new City(-16480.0, -15008.0, UID.PORT)

		//Tanzania
		Cities[4] = new City(-16000.0, -11264.0, UID.CITY)
		Cities[5] = new City(-17280.0, -11328.0, UID.CITY)
		Cities[6] = new City(-17344.0, -9856.0, UID.CITY)
		...
		//Somalia
		Cities[9] = new City(-14016.0, -8640.0, UID.CITY)
		...
		Cities[21] = new City(-16256.0, -1920.0, UID.CITY)
		Cities[22] = new City(-17152.0, -576.0, UID.CITY)

		//Saudia Arabia
		Cities[23] = new City(-12928.0, -448.0, UID.CITY)
		Cities[25] = new City(-15168.0, 128.0, UID.CITY)
		Cities[26] = new City(-13696.0, 1024.0, UID.CITY)
		Cities[27] = new City(-15936.0, 1856.0, UID.CITY)
		Cities[28] = new City(-13472.0, 2528.0, UID.PORT)

		//Iraq
		Cities[29] = new City(-14144.0, 4096.0, UID.CITY)
		Cities[30] = new City(-15104.0, 4864.0, UID.CITY)
		Cities[31] = new City(-14528.0, 6336.0, UID.CITY)

		//Syria
		Cities[32] = new City(-16192.0, 5760.0, UID.CITY)
		Cities[33] = new City(-17536.0, 6336.0, UID.CITY)

		//Turkey
		Cities[34] = new City(-17472.0, 8448.0, UID.CITY)
		Cities[35] = new City(-16192.0, 7744.0, UID.CITY)
		Cities[36] = new City(-15104.0, 8640.0, UID.CITY)

		//Georgia
		Cities[37] = new City(-14784.0, 10048.0, UID.CITY)
		Cities[38] = new City(-13760.0, 9344.0, UID.CITY)

		//South Russia
		Cities[39] = new City(-12608.0, 11328.0, UID.CITY)
		Cities[40] = new City(-14848.0, 12224.0, UID.CITY)
		Cities[41] = new City(-14912.0, 14912.0, UID.CITY)
		Cities[42] = new City(-17024.0, 15744.0, UID.CITY)

		//Ukraine
		Cities[43] = new City(-16320.0, 13824.0, UID.CITY)
		Cities[44] = new City(-17408.0, 13120.0, UID.CITY)

		//East Malaysia
		Cities[45] = new City(8128.0, -10752.0, UID.CITY)
		Cities[46] = new City(10112.0, -8064.0, UID.CITY)
		...
		//North East India
		Cities[51] = new City(1088.0, 576.0, UID.CITY)
		Cities[52] = new City(1984.0, 1920.0, UID.CITY)
		//Nepal
		Cities[53] = new City(-2432.0, 1664.0, UID.CITY)
		Cities[54] = new City(-1344.0, 1088.0, UID.CITY)
		//Tibet (China)
		Cities[55] = new City(1664.0, 3392.0, UID.CITY)
		Cities[56] = new City(192.0, 3712.0, UID.CITY)
		Cities[57] = new City(-1344.0, 3328.0, UID.CITY)
		Cities[58] = new City(-1152.0, 4928.0, UID.CITY)
		Cities[59] = new City(-2560.0, 4544.0, UID.CITY)

		//West Malaysia
		Cities[60] = new City(4288.0, -9152.0, UID.CITY)
		Cities[61] = new City(5280.0, -10144.0, UID.PORT)

		//Yunnan (China)
		Cities[62] = new City(3456.0, 1344.0, UID.CITY)
		Cities[63] = new City(4608.0, 576.0, UID.CITY)


		//South Korea
		Cities[64] = new City(11072.0, 9728.0, UID.CITY)
		...
		Cities[68] = new City(10112.0, 16064.0, UID.CITY)
		...
		//Sapporo (Japan)
		Cities[73] = new City(13632.0, 16064.0, UID.CITY)
		Cities[74] = new City(14496.0, 15584.0, UID.PORT)

		//North Philippines
		Cities[75] = new City(10848.0, -224.0, UID.PORT)
		Cities[76] = new City(11072.0, -1728.0, UID.CITY)
		//South Philippines
		Cities[77] = new City(13440.0, -4736.0, UID.CITY)
		Cities[78] = new City(13216.0, -6048.0, UID.PORT)

		//Hulunbuir Steppes (China)
		Cities[79] = new City(7808.0, 14336.0, UID.CITY)
		Cities[80] = new City(6464.0, 14016.0, UID.CITY)
		Cities[81] = new City(6912.0, 15488.0, UID.CITY)

		//Inner Mongolia
		Cities[82] = new City(2816.0, 8384.0, UID.CITY)
		Cities[83] = new City(4288.0, 8640.0, UID.CITY)
		Cities[84] = new City(6016.0, 10432.0, UID.CITY)

		//South Xinjiang (China)
		Cities[85] = new City(-3968.0, 6144.0, UID.CITY)
		Cities[86] = new City(-1920.0, 6016.0, UID.CITY)
		Cities[87] = new City(-3200.0, 7296.0, UID.CITY)

		//North Xinjiang (China)
		Cities[88] = new City(-896.0, 7552.0, UID.CITY)
		Cities[89] = new City(-2240.0, 8896.0, UID.CITY)
		Cities[90] = new City(320.0, 8128.0, UID.CITY)
		Cities[91] = new City(320.0, 9408.0, UID.CITY)
		Cities[92] = new City(-1600.0, 10176.0, UID.CITY)

		//Mongolia
		Cities[93] = new City(5696.0, 12672.0, UID.CITY)
		Cities[94] = new City(4352.0, 13184.0, UID.CITY)
		Cities[95] = new City(2304.0, 12736.0, UID.CITY)
		Cities[96] = new City(1088.0, 11584.0, UID.CITY)
		Cities[97] = new City(1920.0, 10176.0, UID.CITY)
		Cities[98] = new City(3840.0, 10496.0, UID.CITY)

		//North China
		Cities[99] = new City(8640.0, 11456.0, UID.CITY)
		Cities[100] = new City(7232.0, 11776.0, UID.CITY)
		Cities[101] = new City(8064.0, 12864.0, UID.CITY)
		Cities[102] = new City(7456.0, 10144.0, UID.PORT)

		//Central China
		Cities[103] = new City(1600.0, 4800.0, UID.CITY)
		Cities[104] = new City(576.0, 6080.0, UID.CITY)
		Cities[105] = new City(1792.0, 6528.0, UID.CITY)
		Cities[106] = new City(2816.0, 5568.0, UID.CITY)

		//South India
		Cities[107] = new City(-4864.0, -5888.0, UID.CITY)
		Cities[108] = new City(-3136.0, -5952.0, UID.CITY)
		Cities[109] = new City(-3968.0, -7296.0, UID.CITY)
		Cities[110] = new City(-5344.0, -4768.0, UID.PORT)
		Cities[111] = new City(-2848.0, -4576.0, UID.PORT)

		//Sri Lanka
		Cities[112] = new City(-2208.0, -10976.0, UID.PORT)
		Cities[113] = new City(-3072.0, -9664.0, UID.CITY)

		//Central India
		Cities[114] = new City(-4992.0, -3008.0, UID.CITY)
		Cities[115] = new City(-4352.0, -832.0, UID.CITY)
		Cities[116] = new City(-1664.0, -2368.0, UID.CITY)
		Cities[117] = new City(-3136.0, -3008.0, UID.CITY)
		Cities[118] = new City(-2880.0, -1664.0, UID.CITY)

		//West India
		Cities[119] = new City(-6144.0, -704.0, UID.CITY)
		Cities[120] = new City(-5120.0, 128.0, UID.CITY)
		Cities[121] = new City(-5952.0, 960.0, UID.CITY)

		//Pradesh
		Cities[122] = new City(-2112.0, -128.0, UID.CITY)
		Cities[123] = new City(-3456.0, 576.0, UID.CITY)
		Cities[124] = new City(-4608.0, 1472.0, UID.CITY)

		//North India
		Cities[125] = new City(-3456.0, 2432.0, UID.CITY)
		Cities[126] = new City(-4096.0, 3520.0, UID.CITY)
		Cities[127] = new City(-4544.0, 4672.0, UID.CITY)

		//East China
		Cities[128] = new City(6720.0, 8192.0, UID.CITY)
		Cities[129] = new City(5696.0, 6912.0, UID.CITY)
		Cities[130] = new City(7936.0, 6464.0, UID.CITY)
		Cities[131] = new City(5888.0, 4544.0, UID.CITY)
		Cities[132] = new City(8256.0, 4480.0, UID.CITY)
		Cities[133] = new City(4736.0, 2752.0, UID.CITY)
		Cities[134] = new City(6848.0, 704.0, UID.CITY)
		Cities[135] = new City(8384.0, 2496.0, UID.CITY)

		//Pakistan
		Cities[136] = new City(-7232.0, 1216.0, UID.CITY)
		Cities[137] = new City(-8192.0, 1920.0, UID.CITY)
		Cities[138] = new City(-7104.0, 2880.0, UID.CITY)
		Cities[139] = new City(-5504.0, 3072.0, UID.CITY)
		...
		//Afghanistan
		Cities[148] = new City(-8640.0, 3904.0, UID.CITY)
		Cities[149] = new City(-7296.0, 4096.0, UID.CITY)
		Cities[150] = new City(-8064.0, 5312.0, UID.CITY)
		Cities[151] = new City(-6656.0, 5568.0, UID.CITY)

		//Turkmenistan
		Cities[152] = new City(-8768.0, 7296.0, UID.CITY)
		Cities[153] = new City(-9728.0, 8448.0, UID.CITY)

		//Uzbekistan
		Cities[154] = new City(-7552.0, 8320.0, UID.CITY)
		Cities[155] = new City(-8512.0, 9728.0, UID.CITY)

		//Tajikistan
		Cities[156] = new City(-5056.0, 6848.0, UID.CITY)
		Cities[157] = new City(-7168.0, 6912.0, UID.CITY)

		//Kryg
		Cities[158] = new City(-5056.0, 8768.0, UID.CITY)
		Cities[159] = new City(-3264.0, 8896.0, UID.CITY)

		//Kazakhstan
		Cities[160] = new City(-6080.0, 10176.0, UID.CITY)
		Cities[161] = new City(-6464.0, 11968.0, UID.CITY)
		Cities[162] = new City(-4032.0, 10304.0, UID.CITY)
		Cities[163] = new City(-4928.0, 13184.0, UID.CITY)
		Cities[164] = new City(-3776.0, 11904.0, UID.CITY)
		Cities[165] = new City(-2112.0, 11520.0, UID.CITY)

		//Mangystau (Kazakhstan)
		Cities[166] = new City(-10624.0, 9792.0, UID.CITY)
		Cities[167] = new City(-10752.0, 10880.0, UID.CITY)

		//West Kazakhstan
		Cities[168] = new City(-8320.0, 12160.0, UID.CITY)
		Cities[169] = new City(-9216.0, 13312.0, UID.CITY)
		Cities[170] = new City(-10944.0, 13376.0, UID.CITY)

		//Hainan (China)
		Cities[171] = new City(7136.0, -1504.0, UID.PORT)

		//Volga (Russia)
		Cities[172] = new City(-13120.0, 14976.0, UID.CITY)
		Cities[173] = new City(-12160.0, 16064.0, UID.CITY)

		//Ural (Russia)
		Cities[174] = new City(-11264.0, 15232.0, UID.CITY)
		Cities[175] = new City(-9856.0, 14976.0, UID.CITY)
		Cities[176] = new City(-9088.0, 16000.0, UID.CITY)

		//Central Russia
		Cities[177] = new City(-7616.0, 14528.0, UID.CITY)
		Cities[178] = new City(-7296.0, 16064.0, UID.CITY)
		Cities[179] = new City(-5568.0, 16064.0, UID.CITY)

		//Siberia
		Cities[180] = new City(-1856.0, 14848.0, UID.CITY)
		Cities[181] = new City(384.0, 14144.0, UID.CITY)
		Cities[182] = new City(64.0, 15872.0, UID.CITY)

		//Eastern Russia
		Cities[183] = new City(3072.0, 14720.0, UID.CITY)
		Cities[184] = new City(3904.0, 15936.0, UID.CITY)
		Cities[185] = new City(5184.0, 15488.0, UID.CITY)

		//Cambodia
		Cities[186] = new City(5344.0, -6688.0, UID.PORT)
		Cities[187] = new City(5888.0, -5376.0, UID.CITY)
		Cities[188] = new City(7104.0, -4864.0, UID.CITY)

		//Thailand
		Cities[189] = new City(4352.0, -5248.0, UID.CITY)
		Cities[190] = new City(4736.0, -3904.0, UID.CITY)
		...
		//Vietnam
		Cities[197] = new City(5504.0, -1536.0, UID.CITY)
		Cities[198] = new City(5248.0, -384.0, UID.CITY)

		//Laos
		Cities[199] = new City(6272.0, -3712.0, UID.CITY)
		...
		Cities[204] = new City(-11200.0, -2048.0, UID.CITY)

		//UAE
		Cities[205] = new City(-12352.0, 512.0, UID.CITY)
		Cities[206] = new City(-11264.0, 192.0, UID.CITY)

		//Madagascar
		Cities[207] = new City(-13184.0, -14656.0, UID.CITY)
		Cities[208] = new City(-12032.0, -13632.0, UID.CITY)
		Cities[209] = new City(-13184.0, -12928.0, UID.CITY)
