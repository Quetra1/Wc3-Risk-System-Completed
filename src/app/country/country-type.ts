...
export class Country {
	...
	public static init() {
		...
		Country.fromName.set("Saudi Arabia", new Country("Saudi Arabia", -15046.25, 1210.0, Cities[23], Cities[25], Cities[26], Cities[27], Cities[28]))
		Country.fromName.set("Jordan", new Country("Jordan", -16576.75, 3384.0, Cities[0], Cities[24]))
		Country.fromName.set("Iraq", new Country("Iraq", -14795.75, 5563.0, Cities[30], Cities[31]))
		Country.fromName.set("Syria", new Country("Syria", -16961.0, 5826.0, Cities[32], Cities[33]))
		...
		Country.fromName.set("Ukraine", new Country("Ukraine", -17095.0, 13760.0, Cities[43], Cities[44]))
		...
		Country.fromName.set("North Xinjiang", new Country("North Xinjiang", -712.75, 8504.0, Cities[88], Cities[89], Cities[90], Cities[91]))
		...
		Country.fromName.set("East China", new Country("East China", 6449.5, 3382.25, Cities[130], Cities[131], Cities[132], Cities[133], Cities[134]))
		Country.fromName.set("Pakistan", new Country("Pakistan", -6990.0, 1980.25, Cities[136], Cities[137], Cities[138], Cities[139]))
		Country.fromName.set("Iran", new Country("Iran", -11207.75, 4153.5, Cities[140], Cities[141], Cities[142], Cities[143], Cities[144], Cities[145]))
		...
		Country.fromName.set("Volga", new Country("Volga", -12620.75, 15031.0, Cities[172], Cities[173]))
		...
		Country.fromName.set("Myanmar", new Country("Myanmar", 2360.5, -2374.25, Cities[192], Cities[193], Cities[194]))
		...
		Country.fromName.set("Yemen", new Country("Yemen", -13125.25, -2626.5, Cities[201], Cities[202]))
		Country.fromName.set("Oman", new Country("Oman", -11075.0, -1478.25, Cities[203], Cities[204]))
		Country.fromName.set("UAE", new Country("UAE", -11848.5, -68.5, Cities[205], Cities[206]))
		...
		Country.fromName.set("Central Indonesia", new Country("Central Indonesia", 9530.0, -10949.75, Cities[217], Cities[218], Cities[219]))
		Country.fromName.set("East Indonesia", new Country("East Indonesia", 11964.75, -11455.75, Cities[220], Cities[221]))
		Country.fromName.set("Kuwait", new Country("Kuwait", -14274.0, 3896.5, Cities[92], Cities[128]))
		Country.fromName.set("Shandong", new Country("Shandong", 6465.5, 7225.25, Cities[135], Cities[129], Cities[29]))
